...
class Pipeline:
    ...
    def process(self, source0: np.ndarray) -> DetectedContour:
        ...
        (self.hsl_threshold_output) = self.hsl_threshold(self.__hsl_threshold_input, self.__hsl_threshold_hue,
        ...
        self.__filter_contours_contours = self.find_contours_output
        (self.filter_contours_output) = self.filter_contours(self.__filter_contours_contours,
    ...
    def find_contours(self, ctr_input, external_only):
        ...
        contours, hierarchy = cv2.findContours(ctr_input, mode=mode, method=method)
        return contours
