...
if __name__ == '__main__':
    ...
    cap = cv2.VideoCapture('assets/{}.mov'.format(filename))
    ...
    while True:
        ...
        for contour in contours:
            ...
            # cv2.imwrite('{}/{}_{}_contours.jpg'.format(output_path, filename, date), frame)
